...
var settings_tryon = {
           ...
           buttons:"browse*"+vpath+"Virtual-tryon-master/public/assets/imagesic-browse.png,webcam*"+vpath+"assets/images/ic-camera.png,modelgallery*"+vpath+"assets/images/ic-group.png",
            ...
            permissionDeniedError:"You have denied to access the camera, to restart the cam click the cam icon in the address bar, Allow camera then reload the page",
             modelsimages: ""+vpath+"assets/images/face-1.jpg,"+vpath+"assets/images/face-2.png,"+vpath+"assets/images/face-3.png,"+vpath+"assets/images/face-4.png,"+vpath+"assets/images/face-5.png,"+vpath+"assets/images/face-6.png,",
